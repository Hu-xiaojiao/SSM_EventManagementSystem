    ...
    <div class="add-event-dialog">
        <div id="dlg" class="easyui-dialog" style="width:400px" data-options="closed:true,modal:true,border:'thin',buttons:'#dlg-buttons'">
            <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
                ...
                <div style="margin-bottom:10px">
                    <input name="eventStartDate" data-options="formatter:ww4,parser:w4" class="easyui-datetimebox" required label="开始时间:" style="width:100%">
                </div>
                <div style="margin-bottom:10px">
                    <input name="eventEndDate" data-options="formatter:ww4,parser:w4" class="easyui-datetimebox" required label="结束时间:" style="width:100%">
                </div>
                <div style="margin-bottom: 10px">
        ...
        <!-- 对话框按钮 -->
        <div id="dlg-buttons">
            <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="addEvent()" style="width:90px">保存</a>
    ...
    <div class="edit-event-dialog">
        <div id="dlgEditEvent" class="easyui-dialog" title="修改活动" style="width:400px;padding:20px"
            ...
            <form id="fmEditEvent" method="post" class="easyui-form" data-options="novalidate:true">
                ...
                <h3>活动信息</h3>
                <div style="margin-bottom:10px">
                    <input name="eventName" id="eventName" class="easyui-textbox" required label="活动名称:" style="width:100%">
                </div>
                <div style="margin-bottom:10px">
                    <input name="location" id="location" class="easyui-textbox" required label="活动地点:" style="width:100%">
                </div>
                <div style="margin-bottom:10px">
                    <input name="eventStartDate" id="eventStartDate" data-options="formatter:ww4,parser:w4" class="easyui-datetimebox" required label="开始时间:" style="width:100%">
                </div>
                <div style="margin-bottom:10px">
                    <input name="eventEndDate" id="eventEndDate" data-options="formatter:ww4,parser:w4" class="easyui-datetimebox" required label="结束时间:" style="width:100%">
                </div>
                <div style="margin-bottom: 10px">
                    <select class="easyui-combobox" name="status" id="status" required label="活动状态:" style="width:100%;">
                        <option value="Progressing">进行中</option>
                        <option value="Completed">已结束</option>
                    </select>
                </div>
                <div style="margin-bottom:20px">
                    <input name="eventDescription" id="eventDescription" multiline="true" class="easyui-textbox" label="活动描述:" style="width:100%; height:120px">
                </div>
            </form>
        </div>
        <!-- 对话框按钮 -->
